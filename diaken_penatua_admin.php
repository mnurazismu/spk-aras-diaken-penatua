            ...
            <div class="bg-primary p-4 rounded-lg mt-8 flex flex-col justify-around flex-wrap gap-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex justify-end">
                        <a href="tambah_diaken_penatua_admin.php"><button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        ...
                        <tbody id="table-body">
                            <?php foreach ($alternatif as $key => $value) : ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="./ubah_diaken_penatua_admin.php?id=<?= $value['id_alternatif'] ?>"><button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2 text-center inline-flex gap-1 items-center me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
