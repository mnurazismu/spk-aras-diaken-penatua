...
<body class="font-['Inter'] bg-gradient-to-br from-primary via-secondary to-quinary flex min-h-screen justify-center items-center">
    <div class="w-1/2 shadow-md bg-gray-100 rounded-md py-12">
        <form class="max-w-2xl mx-auto lg:min-w-96" action="" method="post">
            <h1 class="text-2xl text-center font-extrabold tracking-tight leading-none text-quinary dark:text-white">Tambah Kriteria</h1>
            <hr>
            <hr>
            <h3 class="mb-8 mt-2 text-sm">Silahkan lengkapi form berikut ini untuk melanjutkan tambah kriteria.</h3>
            <div class="mb-5">
                <label for="nama_kriteria" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kriteria</label>
                <div class="relative">
                    <input type="text" id="nama_kriteria" name="nama_kriteria" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-rose-800 focus:border-rose-800 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-rose-800 dark:focus:border-rose-800" placeholder="Nama Kriteria" required autocomplete="off" />
            ...
            <div class="mb-5">
                ...
                <div class="flex items-center ps-4 border border-gray-200 bg-white rounded-lg dark:border-gray-700 mb-1">
                    <input id="benefit" type="radio" value="Benefit" name="jenis_kriteria" class="w-4 h-4 text-rose-800 bg-gray-100 border-gray-300 focus:ring-rose-800 dark:focus:ring-rose-800 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="flex items-center ps-4 border border-gray-200 bg-white rounded-lg dark:border-gray-700">
                    <input id="cost" type="radio" value="Cost" name="jenis_kriteria" class="w-4 h-4 text-rose-800 bg-gray-100 border-gray-300 focus:ring-rose-800 dark:focus:ring-rose-800 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    <input type="number" id="jumlah_subkriteria" name="jumlah_subkriteria" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-rose-800 focus:border-rose-800 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-rose-800 dark:focus:border-rose-800" placeholder="Jumlah Sub Kriteria" required autocomplete="off" min="1" max="5" />
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    </div>
                </div>
            </div>
