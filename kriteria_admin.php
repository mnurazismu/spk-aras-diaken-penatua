...
<head>
    ...
    <title>Data Kriteria | SPK Aras</title>
</head>
...
<body class="font-['Inter']">
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-primary sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
            ...
            <div class="bg-primary p-4 rounded-lg mt-8 flex flex-col justify-around flex-wrap gap-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex justify-end">
                        <a href="tambah_kriteria.php"><button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center">
                                            <a onclick="showConfirmationModal(<?php echo $value['id_kriteria']; ?>)"><button type="button" class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2 text-center inline-flex gap-1 items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                                        <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm8.706-1.442c1.146-.573 2.437.463 2.126 1.706l-.709 2.836.042-.02a.75.75 0 0 1 .67 1.34l-.04.022c-1.147.573-2.438-.463-2.127-1.706l.71-2.836-.042.02a.75.75 0 1 1-.671-1.34l.041-.022ZM12 9a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" clip-rule="evenodd" />
                                                    </svg> Subkriteria
                                                </button></a>
                                            <a href="./ubah_kriteria.php?id=<?= $value['id_kriteria'] ?>"><button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2 text-center inline-flex gap-1 items-center me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 m-auto">
                        <thead class="text-sm text-white uppercase dark:text-gray-400">
                            <tr class="border border-primary text-center bg-quinary">
                                <th class="px-6 py-4 border border-primary">No</th>
                                <th class="px-6 py-4 border border-primary">Nama Sub Kriteria</th>
                                <th class="px-6 py-4 border border-primary">Nilai Sub Kriteria</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button onclick="closeModal()" class="bg-rose-700 hover:bg-rose-800 text-white px-4 py-2 rounded-md ml-2">Tutup</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function displaySubcriteria(subcriteria) {
            ...
            subcriteria.forEach(function(subcriterion, index) {
                var row =
                    '<tr class="border border-primary text-center">' +
                    '<td class="px-6 py-4 border border-primary">' + (index + 1) + '</td>' +
                    '<td class="px-6 py-4 border border-primary">' + subcriterion.nama_sub + '</td>' +
                    '<td class="px-6 py-4 border border-primary">' + subcriterion.nilai_sub + '</td>' +
                    '</tr>';
