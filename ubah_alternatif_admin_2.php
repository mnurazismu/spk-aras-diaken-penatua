    ...
    if (isset($_SESSION['id_alternatif'])) {
        ...
        if (isset(($_POST['ubah']))) {
            ...
            if ($result_alternatif) {
                ...
                function myFunction() {
                    document.location.href = "ubah_alternatif_admin_2.php";
                }
                </script>
                ';
                exit;
    ...
    <div class="w-1/2 shadow-md bg-gray-100 rounded-md py-12 my-12">
        <form class="max-w-2xl mx-auto lg:min-w-96" action="" method="post">
            ...
            <div>
                ...
                <a href="./ubah_alternatif_admin.php"><button type="button" class="text-black bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Kembali</button></a>
            </div>
        </form>
    </div>
